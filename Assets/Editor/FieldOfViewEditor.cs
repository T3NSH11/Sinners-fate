...
public class FieldOfViewEditor : Editor
{
    private void OnSceneGUI()
    {
        ...
        Handles.DrawLine(fov.transform.position, fov.transform.position + viewAngle01 * fov.RangeRadius);
        Handles.DrawLine(fov.transform.position, fov.transform.position + viewAngle02 * fov.RangeRadius);
